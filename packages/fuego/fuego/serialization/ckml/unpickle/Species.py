...
class Species(AbstractNode):
    ...
    def onThermo(self, thermo):
        for p in thermo:
            ...
            self._species.thermalParametrization(
                type, lowT, highT, self.document.locator, parameters)
    ...
    def __init__(self, root, attributes):
        ...
        species = self.document.mechanism().newSpecies(symbol, locator)
        species.phase = phase
...
# version
__id__ = "$Id: Species.py,v 1.1.1.1 2007-09-13 18:17:30 aivazis Exp $"
