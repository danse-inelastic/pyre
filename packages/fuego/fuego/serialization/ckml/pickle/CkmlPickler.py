    ...
    def _renderSpecies(self, mechanism):
        ...
        for species in mechanism.species():
            ...
            if thermo:
                ...
                self._indent()
                for model in thermo:
                    self._write('<NASA lowT="%g" highT="%g">' % (model.lowT, model.highT))
                    self._indent()
        ...
        for reaction in mechanism.reaction():
            ...
            if sri:
                ...
                if len(param) == 3:
                    ...
                    tag = '<sri a="%g" b="%g" c="%g" d="%g" e="%g"/>' % tuple(sri)
                else:
                    import journal
                    journal.firewall("fuego").log("poorly formed SRI parameter tuple")
                self._write(tag)
...
# version
__id__ = "$Id: CkmlPickler.py,v 1.1.1.1 2007-09-13 18:17:30 aivazis Exp $"
